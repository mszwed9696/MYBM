      ...
      <article className="py-20 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="font-newspaper text-lg text-gray-700 space-y-6 leading-relaxed font-newspaper text-base text-cartoon-ink">
            ...
            <p>
              Most marketing agencies have zero accountability to results. They charge $5k-$20k monthly retainers whether your revenue grows or not.
            </p>

            <p className="font-bold">Here's their playbook:</p>

            <ul className="list-disc pl-8 space-y-2">
              <li><strong>"We'll provide X hours of service monthly"</strong> → No mention of revenue impact</li>
              <li><strong>"We'll deliver Y leads/impressions/clicks"</strong> → Vanity metrics, not revenue</li>
              <li><strong>"Results take time, marketing is a long-term investment"</strong> → Translation: We're not confident we can move the needle</li>
              <li><strong>"Success depends on many factors outside our control"</strong> → Pre-emptive excuse for failure</li>
            </ul>
            ...
            <ul className="list-disc pl-8 space-y-2">
              <li><strong>$100k+ monthly revenue:</strong> Proven business model, existing customer base</li>
              <li><strong>Product-market fit established:</strong> You know your offer converts, you just need more customers</li>
              <li><strong>Ready to scale infrastructure:</strong> Team/operations can handle 30%+ growth</li>
              <li><strong>Marketing budget available:</strong> $5k-$20k+ monthly for ads, tools, execution</li>
            </ul>
            ...
            <div className="bg-cartoon-cream border-3 border-black p-8 my-8">
              ...
              <ul className="space-y-2">
                ...
                <li><strong>Total revenue added:</strong> $18M+ for client businesses</li>
                <li><strong>Industries served:</strong> Coaching, consulting, courses, SaaS, B2B services</li>
              </ul>
            </div>
            ...
            <p className="font-bold">
              We build revenue systems that compound over time:
            </p>

            <ul className="list-disc pl-8 space-y-2">
              <li><strong>Evergreen acquisition funnels</strong> that convert 24/7 (not one-time campaigns)</li>
              <li><strong>Multi-channel traffic strategies</strong> (paid + organic + partnerships)</li>
              <li><strong>Automated nurture sequences</strong> that convert cold leads over weeks/months</li>
              <li><strong>Backend monetization</strong> increasing LTV through upsells/cross-sells</li>
            </ul>
            ...
            <p className="font-bold">
              Think about that: If we fail, we work for free. If traditional agencies fail, they still collect their retainer.
            </p>
            ...
            <ul className="list-disc pl-8 space-y-2">
              ...
              <li>Month 2: $105k</li>
              <li>Month 3: $100k</li>
              <li><strong>Baseline: $100k/month</strong></li>
            ...
            <ul className="list-disc pl-8 space-y-2">
              <li>Audit current marketing, identify what's broken</li>
              <li>Build evergreen funnels (VSLs, webinars, application funnels)</li>
              <li>Launch paid traffic campaigns (Facebook, Google, YouTube)</li>
              <li>Implement email automation and nurture sequences</li>
            ...
            <p className="font-bold">Month 6 Checkpoint:</p>
            <ul className="list-disc pl-8 space-y-2">
              <li>Are we on track for 30%+ by month 12?</li>
              <li>What's working? What needs adjustment?</li>
              <li>Do we need to double down or pivot?</li>
            </ul>

            <p className="font-bold mt-4">Month 12 Final Measurement:</p>
            <ul className="list-disc pl-8 space-y-2">
              <li>Did you hit 30%+ net revenue growth?</li>
              <li>If yes: Celebrate and plan next phase of growth</li>
            ...
            <p>
              The guarantee covers our service fees. It does not cover:
            </p>

            <ul className="list-disc pl-8 space-y-2">
              <li><strong>Ad spend:</strong> You still pay platforms (Facebook, Google, etc.) for advertising</li>
              <li><strong>Tools/software:</strong> CRM, email platform, funnel builders, etc.</li>
              <li><strong>Third-party services:</strong> Designers, copywriters, developers if needed</li>
            </ul>
            ...
            <div className="bg-cartoon-cream border-3 border-black p-8 my-8">
              ...
              <div className="space-y-6">
                <div>
                  <p className="font-bold">High-Ticket Business Coaching:</p>
                  <p>$80k → $310k/month (287% growth) in 9 months</p>
                </div>

                <div>
                  <p className="font-bold">B2B Consulting Firm:</p>
                  <p>$150k → $385k/month (156% growth) in 12 months</p>
                </div>

                <div>
                  <p className="font-bold">Online Course Creator:</p>
                  <p>$120k → $372k/month (210% growth) in 11 months</p>
                </div>

                <div>
                  <p className="font-bold">B2B SaaS Company:</p>
                  <p>$95k → $283k MRR (198% growth) in 10 months</p>
                </div>
              </div>

              <p className="font-bold mt-6">
                Every single one exceeded the 30% guarantee. That's why we can make this promise.
              </p>
            </div>
            ...
            <p className="text-xl font-bold">
              Guarantees separate confidence from bullshit.
            </p>

            <p className="font-bold">
              Any agency can promise results. We're the only ones willing to work for free if we don't deliver them.
            </p>

            <p>
              If your current marketing partner won't guarantee revenue growth, ask yourself why. Either they don't believe in their work, or they know their tactics don't reliably move the needle.
            </p>

            <p className="font-bold">
              We guarantee 30% because we've done it 50+ times. We know what works. And if we're wrong (we won't be), we'll keep working until we're right—at no cost to you.
            </p>

            <p className="font-bold">
              That's what real accountability looks like. Everything else is just marketing theater.
            </p>
          </div>
        </div>
      </article>
