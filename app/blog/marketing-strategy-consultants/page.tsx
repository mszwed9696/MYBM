        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="font-newspaper text-lg text-gray-700 space-y-6 leading-relaxed font-newspaper text-base text-cartoon-ink">
            ...
            <ul className="list-disc pl-8 space-y-2">
              <li>"Launch paid acquisition campaigns on Facebook and Google"</li>
              <li>"Build content marketing funnel targeting high-intent keywords"</li>
              <li>"Implement marketing automation and lead nurturing sequences"</li>
              <li>"Optimize conversion rates across landing pages"</li>
            </ul>

            <p>
              Great. Now what? <strong>You still need someone to actually do all of that.</strong>
            </p>
            ...
            <ul className="list-disc pl-8 space-y-2">
              <li>They run the same "diagnostic" they run for every client</li>
              <li>They plug your data into their templated frameworks</li>
              <li>They give you the same recommendations they gave the last 10 clients</li>
              <li>They brand it as "customized strategy" and charge $30k-$50k</li>
            </ul>
            ...
            <ul className="list-disc pl-8 space-y-2">
              <li><strong>Campaign thinking:</strong> "Let's run Facebook ads to a webinar."</li>
              <li><strong>Systems thinking:</strong> "Let's build an evergreen acquisition engine that captures cold traffic, nurtures them through automated sequences, converts them on VSL funnels, and upsells them into backend offers—predictably and profitably."</li>
            </ul>
            ...
            <p>
              <strong>Translation:</strong> "We're going to spend 4-6 weeks interviewing your team, analyzing your data, and researching your market—and then we'll tell you what you probably already know."
            </p>
            ...
            <ul className="list-disc pl-8 space-y-2">
              <li>"What's your LTV and CAC?"</li>
              <li>"What's your current close rate and sales cycle?"</li>
              <li>"How much can you spend to acquire a customer?"</li>
              <li>"What have you tried that failed, and why did it fail?"</li>
            </ul>
            ...
            <ul className="list-disc pl-8 space-y-2">
              <li><strong>Bad consultants</strong> deliver strategies and disappear</li>
              <li><strong>Good consultants</strong> build revenue systems and stick around until they work</li>
            </ul>
