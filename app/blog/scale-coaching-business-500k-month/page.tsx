      ...
      <section className="relative bg-gradient-to-br from-[#2a1a4a] via-[#1a1a2e] to-black text-white py-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{ fontFamily: "'Georgia', serif" }}>
            How to Scale a High-Ticket Coaching Business to $500k/Month
          </h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-gray-700 mb-6 leading-relaxed font-semibold">
              The exact playbook we use to scale coaching businesses from $100k to $500k+ monthly revenue. No fluff, just what actually works.
            </p>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Welcome to this comprehensive guide on how to scale a high-ticket coaching business to $500k/month. In this article, we'll break down proven strategies, frameworks, and actionable steps you can implement in your business today.
            </p>
