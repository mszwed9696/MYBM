    ...
    <div>
      ...
      <section className="relative bg-gradient-to-br from-[#2a1a4a] via-[#1a1a2e] to-black text-white py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.h1
            className="text-5xl md:text-7xl font-bold mb-6" style={{ fontFamily: "\'Georgia\', serif" }}
          ...
          <div className="space-y-8">
            <div className="bg-gray-50 p-8 rounded-xl">
              <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 bg-[#8B0000] border-2 border-[#FFD700] text-white rounded-full flex items-center justify-center font-bold text-xl mr-6">
                  1
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white mb-3">Baseline Revenue Documentation</h3>
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-3">12-Month Partnership Period</h3>
                  <p className="text-lg text-gray-300">
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-3">30% Revenue Increase Target</h3>
                  <p className="text-lg text-gray-300">
            ...
            <div className="bg-blue-50 border-2 border-blue-600 p-8 rounded-xl">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-3">If We Miss the Target...</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h3 className="text-2xl font-bold text-white mb-4">Selective Client Criteria</h3>
              <p className="text-lg text-gray-300">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h3 className="text-2xl font-bold text-white mb-4">High-Ticket Specialization</h3>
              <p className="text-lg text-gray-300">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h3 className="text-2xl font-bold text-white mb-4">Comprehensive Execution</h3>
              <p className="text-lg text-gray-300">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-white mb-8 text-center" style={{ fontFamily: "\'Georgia\', serif" }}>
            Important Terms & Conditions
          </h2>

          <div className="bg-yellow-50 border-2 border-yellow-600 p-8 rounded-xl mb-8">
            <h3 className="text-2xl font-bold text-white mb-4">Guarantee Requirements</h3>
          ...
          <div className="bg-gray-50 p-8 rounded-xl">
            <h3 className="text-2xl font-bold text-white mb-4">What Voids the Guarantee</h3>
            <ul className="space-y-2 text-gray-200">
              <li className="flex items-start">
