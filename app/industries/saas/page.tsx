    ...
    <div>
      <section className="relative bg-gradient-to-br from-[#2a1a4a] via-[#1a1a2e] to-black text-white py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img src="/heroes/saas-hero.png" alt="Cityscape" className="w-full h-full object-cover opacity-40"  loading="lazy" />
        ...
        <div className="absolute right-0 bottom-0 w-80 md:w-96 lg:w-[500px] z-0">
          <img src="/characters/saas-character.png" alt="The Innovator" className="w-full h-auto opacity-90"  loading="lazy" />
        </div>
