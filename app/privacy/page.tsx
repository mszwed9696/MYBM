  ...
  return (
    <div className="bg-gradient-to-b from-[#1a1a2e] to-black">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-8" style={{ fontFamily: "\'Georgia\', serif" }}>Privacy Policy</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-300">Email: privacy@mindyourbusinessmedia.com</p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">14. GDPR Compliance (European Users)</h2>
            <p className="text-gray-300 mb-4">
