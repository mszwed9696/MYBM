          ...
          <div className="font-newspaper text-base text-gray-700 space-y-8 leading-relaxed">
            ...
            <div>
              ...
              <ul className="list-disc pl-8 space-y-2">
                ...
                <li>Business performance data and financial information when working together as partners</li>
              </ul>
              <p className="mt-4"><strong>Automatically Collected Information:</strong> When you visit our website, we automatically collect:</p>
              <ul className="list-disc pl-8 space-y-2">
            ...
            <div>
              ...
              <ul className="list-disc pl-8 space-y-2">
                ...
                <li><strong>Business Partners:</strong> When necessary to deliver our services (e.g., advertising platforms, CRM systems)</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-8 space-y-2">
                ...
                <li>Opt out of marketing communications (unsubscribe links provided in emails)</li>
                <li>Disable cookies through your browser settings (may affect website functionality)</li>
