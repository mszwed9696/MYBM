        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {caseStudies.map((study, index) => (
              ...
              >
                <div className="bg-gradient-to-r from-[#2a1a4a] via-[#1a1a2e] to-[#8B0000] text-white p-8">
                  <div className="flex flex-wrap items-center justify-between mb-4">
                    <div>
                      <div className="text-sm font-semibold text-[#FFD700] mb-2">{study.industry}</div>
                      <h3 className="text-3xl font-bold" style={{ fontFamily: "'Georgia', serif" }}>{study.title}</h3>
                    </div>
                    <div className="bg-white/20 backdrop-blur-sm px-6 py-4 rounded-lg mt-4 md:mt-0 border-2 border-[#FFD700]/30">
                      <div className="text-5xl font-bold text-[#FFD700]" style={{ fontFamily: "'Georgia', serif" }}>{study.increase}</div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#8B0000] via-[#2a1a4a] to-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.h2
            ...
            transition={{ duration: 0.8 }}
          >
            Ready to Become Our Next <span className="text-[#FFD700]">Success Story?</span>
          </motion.h2>
          <motion.p
