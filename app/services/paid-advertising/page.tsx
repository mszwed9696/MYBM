    ...
    <div>
      ...
      <section className="relative bg-black text-white py-32 overflow-hidden min-h-[70vh] flex items-center">
        ...
        <div className="absolute inset-0 z-0 flex items-center justify-center">
          <img src="/heroes/paid-advertising-hero.png" alt="Vegas Strip" className="w-full h-full object-cover"  style={{ objectPosition: "center center" }}/>
        ...
        >
          <img src="/characters/paid-advertising-character.png" alt="The Enforcer" className="w-full h-auto" />
        </div>
