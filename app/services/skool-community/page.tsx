    ...
    <div>
      ...
      <section className="relative bg-black text-white py-32 overflow-hidden min-h-[70vh] flex items-center">
        ...
        <div className="absolute inset-0 z-0 flex items-center justify-center">
          <img src="/heroes/skool-community-hero.png" alt="Skool Community" className="w-full h-full object-cover" style={{ objectPosition: "center center" }} />
        ...
        >
          <img src="/characters/skool-community-character.png" alt="Community Boss" className="w-full h-auto" />
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-[#1a1a2e] to-black p-8 rounded-xl border-2 border-[#FFD700]/30 hover:border-[#FFD700] transition-all">
              <h3 className="text-xl font-bold text-[#FFD700] mb-3" style={{ fontFamily: "'Georgia', serif" }}>Community Funnel Strategy</h3>
            ...
            <div className="bg-gradient-to-br from-[#1a1a2e] to-black p-8 rounded-xl border-2 border-[#FFD700]/30 hover:border-[#FFD700] transition-all">
              <h3 className="text-xl font-bold text-[#FFD700] mb-3" style={{ fontFamily: "'Georgia', serif" }}>Paid Ads to Community Pipeline</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gradient-to-br from-[#1a1a2e] to-black p-8 rounded-xl border-2 border-[#FFD700]/30 hover:border-[#FFD700] transition-all">
              <h3 className="text-xl font-bold text-[#FFD700] mb-3" style={{ fontFamily: "'Georgia', serif" }}>Skool Setup & Optimization</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gradient-to-br from-[#1a1a2e] to-black p-8 rounded-xl border-2 border-[#FFD700]/30 hover:border-[#FFD700] transition-all">
              <h3 className="text-xl font-bold text-[#FFD700] mb-3" style={{ fontFamily: "'Georgia', serif" }}>Engagement & Retention Systems</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gradient-to-br from-[#1a1a2e] to-black p-8 rounded-xl border-2 border-[#FFD700]/30 hover:border-[#FFD700] transition-all">
              <h3 className="text-xl font-bold text-[#FFD700] mb-3" style={{ fontFamily: "'Georgia', serif" }}>Content & Curriculum Design</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gradient-to-br from-[#1a1a2e] to-black p-8 rounded-xl border-2 border-[#FFD700]/30 hover:border-[#FFD700] transition-all">
              <h3 className="text-xl font-bold text-[#FFD700] mb-3" style={{ fontFamily: "'Georgia', serif" }}>Application & Onboarding Funnels</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gradient-to-br from-[#1a1a2e] to-black p-8 rounded-xl border-2 border-[#FFD700]/30 hover:border-[#FFD700] transition-all">
              <h3 className="text-xl font-bold text-[#FFD700] mb-3" style={{ fontFamily: "'Georgia', serif" }}>Churn Reduction Strategies</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gradient-to-br from-[#1a1a2e] to-black p-8 rounded-xl border-2 border-[#FFD700]/30 hover:border-[#FFD700] transition-all">
              <h3 className="text-xl font-bold text-[#FFD700] mb-3" style={{ fontFamily: "'Georgia', serif" }}>Analytics & Optimization</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gradient-to-br from-[#1a1a2e] to-black p-8 rounded-xl border-2 border-[#FFD700]/30 hover:border-[#FFD700] transition-all">
              <h3 className="text-xl font-bold text-[#FFD700] mb-3" style={{ fontFamily: "'Georgia', serif" }}>Upsell & Expansion Revenue</h3>
              <p className="text-gray-300">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-[#1a1a2e] to-black p-8 rounded-xl border-2 border-[#FFD700] text-center">
