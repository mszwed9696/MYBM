    ...
    <div className="bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Partnership Application Process</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Revenue Guarantee</h2>
            <p className="text-gray-600 mb-4">
              Mind Your Business Media offers a 30% net revenue increase guarantee subject to the following terms:
            </p>

            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Guarantee Terms</h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Client Obligations for Guarantee</h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Guarantee Exclusions</h3>
            <p className="text-gray-600 mb-4">The guarantee does not apply if:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
          ...
          <section>
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Our Content</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Work Product</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Governing Law</h3>
            <p className="text-gray-600 mb-4">
              These Terms shall be governed by and construed in accordance with the laws of the United States, without
              regard to its conflict of law provisions.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Arbitration</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Entire Agreement</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Severability</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Waiver</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Assignment</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 mt-6">Force Majeure</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">Email: legal@mindyourbusinessmedia.com</p>
